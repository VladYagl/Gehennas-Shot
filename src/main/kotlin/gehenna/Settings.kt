...
val colorConverter = object: Converter {
    ...
    override fun fromJson(jv: JsonValue)
            = Color(jv.objInt("r"), jv.objInt("g"), jv.objInt("b"))

}

val fontConverter = object: Converter {
    override fun canConvert(cls: Class<*>)
            = cls == AsciiFont::class.java
    ...
    override fun fromJson(jv: JsonValue)
            = AsciiFont(jv.objString("file"), jv.objInt("width"), jv.objInt("height"))

}

val klaxon = Klaxon().converter(colorConverter).converter(fontConverter)
